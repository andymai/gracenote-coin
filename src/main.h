...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 576 / 250; // 5760 blocks found a day. Priority cutoff is 1 GNC day / 250 bytes.
    }
 ...
 * need to upgrade.  The message is displayed in the status GNC.
